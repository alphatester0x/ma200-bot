...
STOPLOSS_PCT          = -15.0       # fallback flat SL jika dynamic SL tidak tersedia
MAX_TRACK_HOURS       = 72
VOLUME_MULTIPLIER     = 1.5         # volume minimum vs 20-bar average

# Entry & Risk management
MIN_RR_RATIO          = 1.5         # sinyal dengan R/R < ini diberi warning
SL_BUFFER_PCT         = 1.0         # % di bawah swing low untuk dynamic SL
SR_LOOKBACK           = 50          # bar lookback untuk swing high/low
